              ...
              if(done){
                  console.log('----------'+done.styleint+'-----------');
                    if(!done.books&&!done.movies)
                      ...
                      var style5 = "'bcl':'white','mcl':'white','mh':'#2e83b0','bh':'#2e83b0','mhl':'#F56979','bhl':'rgb(103, 186, 255)','yet':'color:white','small':'color:white;opacity:0.5;','spanop':'0.1','addbook':'rgba(103, 186, 255, 0.63)','addmovie':'rgba(245, 105, 121, 0.83)',";
